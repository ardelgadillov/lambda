...
public:
  ...
  */
  ...
  /***************Funciones Andres *********/
    wxString ReturnDataString(int row, int col);
    int ReturnDataInt(int row, int col);
    double ReturnDataDouble(int row, int col);
  /********************************************/
...
public:
  ...
  */
  ...
  /****************FUNCIONES ANDRES ****/
  //Return the data in (row, col) from the table
  wxString ReturnDataString(wxString table, int row, int col);
  int ReturnDataInt(wxString table, int row, int col);
  double ReturnDataDouble(wxString table, int row, int col);
  /*************************************/
